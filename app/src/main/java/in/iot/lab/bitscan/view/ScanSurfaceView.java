...
import in.iot.lab.bitscan.ui.ScanActivity;
import in.iot.lab.bitscan.util.ImageDetectionProperties;
...
public class ScanSurfaceView extends FrameLayout implements SurfaceHolder.Callback {
    ...
    public ScanSurfaceView(Context context, ScanActivity iScanner) {
        super(context);
